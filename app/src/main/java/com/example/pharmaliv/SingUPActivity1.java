...
public class SingUPActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sing_);
        initializeUI();
    ...
    public void initializeUI() {
        ...
        editTextFirstName = findViewById(R.id.cl_first_name);
        editTextFamilyName = findViewById(R.id.cl_family_name);
